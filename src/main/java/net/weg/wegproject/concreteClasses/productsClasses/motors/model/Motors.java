...
<<<<<<< Updated upstream:src/main/java/net/weg/wegproject/motors/model/Motors.java
import net.weg.wegproject.enums.IsolationClass;
import net.weg.wegproject.product.model.entity.Product;
=======
import net.weg.wegproject.concreteClasses.productsClasses.product.model.entity.Product;
import net.weg.wegproject.enums.IsolationClass;
>>>>>>> Stashed changes:src/main/java/net/weg/wegproject/concreteClasses/productsClasses/motors/model/Motors.java
